...
To use these stylesheets, rename the files and visustock with the name of your theme.
...
visustock-alpha-default-narrow.css  
...
visustock-alpha-default-normal.css
...
visustock-alpha-default-wide.css
